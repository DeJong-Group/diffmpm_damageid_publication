...
import os
filename = f"results_42/additive/r_c_add_{case}_{obs}_{n_search}_p1_2_{noisetype}_{SNR_dB}_f.json"
if not os.path.exists(filename):
    ...
    for z in range(n_search):
        ...
        locked_indices[z] = damage_index
        locked_values[z] = E_search[damage_index - np.sum(curr_locked <= damage_index)]
        print(filename, ', found: ', locked_values[z], " at ", locked_indices[z])
        # append result
