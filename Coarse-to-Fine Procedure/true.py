...
def gaussian_damage(center, start=3600, cov=[[10, 0], [0, 10]]):
...
E_np_ht = gradient_damage(E_np_ht, n_particles-Nx-128, 2, 16)
...
def assign_E():
    ...
    if case == 'd5':
        for i in range(3):
            for j in range(3):
                E[128 + Nx*i + j] = 4000*0.95
    if case == 'd10':
        for i in range(3):
            for j in range(3):
                E[128 + Nx*i + j] = 4000*0.9
